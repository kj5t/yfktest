...
##
## 14 Added '-x'  option to inhibit PTT. This is  a quick software fix
##    for  keying  problems incurred:  'Winkeyer2  USB  Lite' with  K2
##    transceiver and  a moulded 1/8"  stereo keying lead. On  WK3 SMD
##    keyers you don't need this fix. Simply unplug the PTT cinch plug.
##
...
our ($opt_e, $opt_m, $opt_x);

getopts("xemVnp:s:d:s:q:");
